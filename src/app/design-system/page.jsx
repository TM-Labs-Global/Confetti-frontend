...
import { EventTile, StatusBadge, StatCard, EmptyState, Tabs, BudgetBar, Breadcrumb, PageHeader } from '@/components/ui'
            ...
            <div className="flex items-end gap-8 mb-8">
              {(['sm', 'md', 'lg', 'xl'] ).map(size => (
                <div key={size} className="flex flex-col items-center gap-2">
                  <EventTile emoji={weddingMeta.emoji} bg={weddingMeta.bg} size={size} />
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {Object.entries(EVENT_META).map(([key, m]) => (
                <div key={key} className="flex items-center gap-2">
                  <EventTile emoji={m.emoji} bg={m.bg} size="sm" />
        ...
        <Section title="Composed Example · Plan card">
          <div className="bg-white border border-border rounded-xl p-5 hover:border-primary/40 hover:shadow-sm transition-all">
            <div className="flex items-center gap-4">
              <EventTile emoji={weddingMeta.emoji} bg={weddingMeta.bg} size="md" />
