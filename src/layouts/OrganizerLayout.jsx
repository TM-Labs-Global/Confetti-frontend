...
const NAV_ITEMS = [
  ...
  { label: 'Create Plan', path: '/organiser/create-plan' },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-brand-navy flex flex-col shrink-0">
        <div className="px-6 py-5 border-b border-white/10">
          ...
          <p className="text-xs text-white/40 mt-0.5 uppercase tracking-widest">Organiser</p>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6 shrink-0">
          <h1 className="text-base font-semibold text-brand-navy">Organiser Portal</h1>
