    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-brand-navy flex flex-col shrink-0">
        <div className="px-6 py-5 border-b border-white/10">
          ...
          <p className="text-xs text-white/40 mt-0.5 uppercase tracking-widest">Vendor</p>
        </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3 mb-3 px-1">
            <div className="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center text-brand-navy text-xs font-bold shrink-0">
              {initials}
            </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6 shrink-0">
          <h1 className="text-base font-semibold text-brand-navy">Vendor Portal</h1>
          <div className="ml-auto flex items-center gap-3">
            <span className="text-sm text-gray-400">Welcome, {user?.name?.split(' ')[0]}</span>
            <div className="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center text-brand-navy text-xs font-bold">
              {initials}
            </div>
          </div>
        </header>
